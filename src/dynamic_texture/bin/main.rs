...
impl App for DynamicTextureApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            let time_unix = SystemTime::now()
                ...
                .as_millis()
                / 10;
            let red_value = time_unix as u8;
            let tex_color_start = Color32::from_rgb(red_value, 128, 255);
            let tex_color_end = Color32::from_rgb(red_value, 64, 255);
